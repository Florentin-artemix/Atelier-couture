...
@section('content')
    <div class="flex items-center justify-between mb-6">
        ...
        <button @click="$dispatch('open-modal-add-realisation')" class="inline-flex items-center px-4 py-2 bg-terracotta-500 text-white rounded-couture hover:bg-terracotta-600 transition text-sm">
    ...
    <x-ui.modal name="add-realisation" title="Nouvelle realisation">
